...
with st.sidebar:
    ...
    <div style="text-align:center; padding:15px 0 5px 0;">
        ...
        <div style="font-size:1.1rem; font-weight:800; color:#63b3ed; letter-spacing:0.03em;">
            AI Workforce<br>Intelligence
        </div>
        <div style="font-size:0.72rem; color:#94a3b8; margin-top:3px;">Enterprise HR Platform v2.0</div>
    </div>
    """, unsafe_allow_html=True)
    ...
    selected_menu = option_menu(
        ...
        styles={
            ...
            "nav-link": {
                ...
                "color": "#cbd5e1",
                "border-radius": "10px",
                "--hover-color": "rgba(99, 179, 237, 0.15)",
            },
            "nav-link-selected": {
    ...
    current = pages[selected_menu]

    st.markdown("<hr style='border-color:rgba(99,179,237,0.15); margin:12px 0;'>", unsafe_allow_html=True)
    st.markdown("""
    <div style="font-size:0.7rem; color:#94a3b8; text-align:center; padding:4px 0;">
...
elif current in ["attrition", "simulator"]:
